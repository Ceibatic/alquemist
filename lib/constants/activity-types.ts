...
export const DEFAULT_ACTIVITY_TYPES: DefaultActivityType[] = [
  ...
  { code: "inventory_transformation", name: "Transformacion de inventario", category: "transformation", icon: "Combine", color: "violet", requires_zone: true, requires_batch: false, requires_resources: true, requires_photos: false, requires_verification: false, triggers_transformation: true, triggers_phase_change: false, description: "Transformacion de materias primas en productos" },
  ...
  { code: "inventory_receipt", name: "Recepcion de inventario", category: "movement", icon: "PackagePlus", color: "cyan", requires_zone: true, requires_batch: false, requires_resources: true, requires_photos: false, requires_verification: false, triggers_transformation: false, triggers_phase_change: false, description: "Ingreso de producto al inventario" },
  { code: "inventory_consumption", name: "Consumo de inventario", category: "movement", icon: "PackageMinus", color: "cyan", requires_zone: true, requires_batch: false, requires_resources: true, requires_photos: false, requires_verification: false, triggers_transformation: false, triggers_phase_change: false, description: "Consumo de producto del inventario" },
  { code: "inventory_return", name: "Devolucion de inventario", category: "movement", icon: "Undo2", color: "cyan", requires_zone: true, requires_batch: false, requires_resources: true, requires_photos: false, requires_verification: false, triggers_transformation: false, triggers_phase_change: false, description: "Devolucion de producto al inventario" },
  ...
  { code: "inventory_correction", name: "Correccion de inventario", category: "administrative", icon: "ClipboardEdit", color: "gray", requires_zone: true, requires_batch: false, requires_resources: true, requires_photos: false, requires_verification: false, triggers_transformation: false, triggers_phase_change: false, description: "Ajuste por conteo fisico o error" },
  { code: "inventory_waste", name: "Baja de inventario", category: "administrative", icon: "Trash2", color: "gray", requires_zone: true, requires_batch: false, requires_resources: true, requires_photos: false, requires_verification: false, triggers_transformation: false, triggers_phase_change: false, description: "Descarte o desperdicio de producto" },
];
