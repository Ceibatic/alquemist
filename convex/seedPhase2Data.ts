...
export const seedCultivars = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Note: characteristics, optimal_conditions are v.object({}) in schema, so we skip detailed fields
    const cannabisStrains = [
      {
        name: "Blue Dream",
        crop_type_id: cannabisType._id,
        variety_type: "Sativa-dominant Hybrid",
        genetic_lineage: "Blueberry x Haze",
        performance_metrics: {},
        status: "active",
        notes: "THC: 17-24%, CBD: 0.1-0.2%, Floración: 65 días. Aromas: blueberry, sweet, herbal. Efectos: relaxed, creative, euphoric. Terpenos: myrcene, pinene, caryophyllene. Rendimiento: 500-600g/m² indoor, 600-800g/plant outdoor. Temp día: 24°C, noche: 18°C, HR veg: 60%, HR flor: 45%, pH: 6.0-6.5, EC: 1.2-1.8. Excelente para climas tropicales, resistente a humedad.",
        created_at: now - 180 * 24 * 60 * 60 * 1000,
      },
      {
        name: "OG Kush",
        crop_type_id: cannabisType._id,
        variety_type: "Indica-dominant Hybrid",
        genetic_lineage: "Hindu Kush x Chemdawg",
        performance_metrics: {},
        status: "active",
        notes: "THC: 20-26%, CBD: 0.1-0.3%, Floración: 56 días. Aromas: pine, fuel, earthy. Efectos: happy, relaxed, uplifted. Terpenos: limonene, myrcene, linalool. Rendimiento: 400-500g/m² indoor, 500-600g/plant outdoor. Temp día: 23°C, noche: 17°C, HR veg: 55%, HR flor: 40%, pH: 6.0-6.8, EC: 1.4-2.0. Genética estable, ideal para producción comercial.",
      ...
      },
      {
        ...
        performance_metrics: {},
        status: "active",
        notes: "THC: 22-28%, CBD: 0.09-0.2%, Floración: 63 días. Aromas: sweet, earthy, mint. Efectos: euphoric, relaxed, creative. Terpenos: caryophyllene, limonene, humulene. Rendimiento: 350-450g/m² indoor, 450-550g/plant outdoor. Alto THC, requiere control estricto de humedad en floración.",
        created_at: now - 150 * 24 * 60 * 60 * 1000,
      },
      {
        name: "White Widow",
        crop_type_id: cannabisType._id,
        variety_type: "Balanced Hybrid",
        genetic_lineage: "Brazilian Sativa x South Indian Indica",
        performance_metrics: {},
        status: "active",
        notes: "THC: 18-25%, CBD: 0.1-0.2%, Floración: 60 días. Aromas: earthy, woody, pungent. Efectos: energetic, creative, euphoric. Terpenos: myrcene, caryophyllene, pinene. Rendimiento: 450-550g/m² indoor, 550-700g/plant outdoor. Muy estable, excelente para principiantes.",
      ...
      },
      {
        ...
        performance_metrics: {},
        status: "active",
        notes: "THC: 25-30%, CBD: 0.1%, Floración: 58 días. Aromas: diesel, pine, chocolate. Efectos: relaxed, sleepy, euphoric. Terpenos: caryophyllene, limonene, myrcene. Rendimiento: 500-600g/m² indoor, 600-800g/plant outdoor. Muy resinosa, ideal para extracciones.",
        created_at: now - 120 * 24 * 60 * 60 * 1000,
      },
      {
        name: "Amnesia Haze",
        crop_type_id: cannabisType._id,
        variety_type: "Sativa-dominant",
        genetic_lineage: "South Asian x Jamaican x Laos x Afghan Hawaiian",
        performance_metrics: {},
        status: "active",
        notes: "THC: 20-25%, CBD: 0.1%, Floración: 77 días. Aromas: citrus, lemon, earthy. Efectos: energetic, uplifted, happy. Terpenos: terpinolene, limonene, caryophyllene. Rendimiento: 600-700g/m² indoor, 700-900g/plant outdoor. Floración larga pero alto rendimiento.",
        created_at: now - 90 * 24 * 60 * 60 * 1000,
      },
      {
        name: "Colombian Gold",
        crop_type_id: cannabisType._id,
        variety_type: "Pure Sativa",
        genetic_lineage: "Landrace Colombiana (Santa Marta)",
        performance_metrics: {},
        status: "active",
        notes: "THC: 16-20%, CBD: 0.5-1%, Floración: 84 días. Aromas: citrus, lemon, skunk, tropical. Efectos: energetic, focused, creative, uplifted. Terpenos: limonene, pinene, terpinolene. Rendimiento: 400-500g/m² indoor, 500-700g/plant outdoor. Genética nativa colombiana, perfectamente adaptada al clima local. Patrimonio genético.",
        created_at: now - 400 * 24 * 60 * 60 * 1000,
      },
      {
        name: "Critical Mass",
        crop_type_id: cannabisType._id,
        variety_type: "Indica-dominant",
        genetic_lineage: "Afghani x Skunk #1",
        performance_metrics: {},
        status: "active",
        notes: "THC: 19-22%, CBD: 5-8%, Floración: 50 días. Aromas: sweet, honey, earthy. Efectos: relaxed, pain relief, sleepy. Terpenos: myrcene, caryophyllene, pinene. Rendimiento: 600-750g/m² indoor, 650-800g/plant outdoor. Alto CBD, ideal para uso medicinal. Cogollos muy densos - cuidado con botrytis.",
